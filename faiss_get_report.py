...
if __name__ == "__main__":
    ...
    plot_subplot('search_time_npiece_k',search_time_npiece_k, data_choice='glove', dim=25,faiss_style='HNSW64')
    plot_subplot('search_recall_npiece_k',search_recall_npiece_k, data_choice='glove', dim=25,faiss_style='HNSW64')
    # report_number_k可视化
    ...
    plot_subplot('search_time_number_k',search_time_number_k, data_choice='glove', dim=25,faiss_style='HNSW64')
    plot_subplot('search_recall_number_k',search_recall_number_k, data_choice='glove', dim=25, faiss_style='HNSW64')
    ...
    plot_subplot('search_time_npiece_number',search_time_npiece_number, data_choice='glove', dim=25,faiss_style='HNSW64')
    plot_subplot('search_recall_npiece_number',search_recall_npiece_number, data_choice='glove', dim=25,faiss_style='HNSW64')
